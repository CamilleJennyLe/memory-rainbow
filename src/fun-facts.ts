...
const catFunFacts = [
  ...
  "Les chats se souviennent de ce qui est important pour leur survie. Un bruit de sac plastique qui les a surpris une fois ? Ils éviteront cet endroit pendant des semaines. Leur cerveau est câblé pour la survie, pas pour la dignité.",
  ...
  "Les chats construisent une carte mentale de leur territoire : obstacles, hauteurs, chemins rapides, zones sûres. C’est pour ça qu’ils peuvent se déplacer dans le noir sans rien renverser… sauf quand ils veulent attirer ton attention.",
...
const aquaticFunFacts = [
  ...
  "Les poulpes reconnaissent les humains individuellement et peuvent aimer ou détester certains soigneurs.",
  "Un poulpe peut apprendre en observant un autre poulpe — un comportement rare chez les animaux.",
  "La mémoire des poulpes mémoire est distribuée : deux tiers de leurs neurones sont dans leurs bras, qui peuvent apprendre des choses indépendamment du cerveau central.",
  ...
  "Les dauphins se souviennent des alliances, des conflits, et des individus fiables ou non — un vrai Game of Thrones sous-marin.",
